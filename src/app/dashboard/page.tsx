...
export default function Dashboard() {
	...
	const handleDeleteCall = (event: any) => {
		console.log(event);
		const productIds = activeCardIds.filter(
	...
	const fetchProducts = async (idToken: any) => {
		try {
			...
			console.error(
				"Error fetching and grouping products:",
				error
			);
			setProducts({
				loading: false,

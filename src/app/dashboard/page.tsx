    ...
    if (status === "authenticated")
      getProducts({
        ...
        const groupedProducts = groupBy(response.data, (ele) => {
          const timeDiff =
            new Date(ele.product_expiry_date * 1000).getTime() -
            new Date().getTime();
                  ...
                  {(products as any).data?.["3"] != null
                    ...
                    (products as any).data["3"].map(
                        (ele: {
                          ...
                          product_name: any;
                          product_expiry_date: any;
                          product_added_date: any;
                          product_image: any;
                          product_quantity: any;
                        }) => (
                          <div className="col-span-3" key={ele.product_id}>
                            <Cards
                              name={ele.product_name}
                              expiry_date={ele.product_expiry_date}
                              added_date={ele.product_added_date}
                              image={ele.product_image}
                              quantity={ele.product_quantity}
                            />
                          </div>
                        )
                      )
